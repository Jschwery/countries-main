...
function PopulationsUpdate({ population, shown }: Populations) {
  return (
    <>
      {shown && (
        <div
          className={`flex flex-col justify-between rounded p-2 mt-1 shadow-black shadow-sm dark:bg-slate-600 w-[95%] min-w-[250px]  max-w-[300px] h-auto 
          `}>
